...
async def update_item_2(*, item_id: int, item: Item1, user: User, importance: int = Body(..., gt = 0), q: Optional[str] = None): # importance must > 0
...
async def read_item_3(item_id: str, short: bool = False): # param short với định dạng boolean có giá trị mặc định là False
